...
export const getAllPizzas = () => async (dispatch) => {
    ...
    try {
        const res = await axios.get('https://first-api-zvey.onrender.com/api/pizzas/getAllPizzas')
...
export const addNewPizza = (pizza) => async (dispatch) => {
    ...
    try {
        const res = await axios.post('https://first-api-zvey.onrender.com/api/pizzas/addNewPizza', pizza)
...
export const updatePizza = ({pid,pizza}) => async (dispatch) => {
    ...
    try {
        const res = await axios.put('https://first-api-zvey.onrender.com/api/pizzas/updatePizza', {pid,pizza})
...
export const deletePizza = (id) => async (dispatch) => {
    ...
    try {
        ...
        const res = await axios.delete(`https://first-api-zvey.onrender.com/api/pizzas/deletePizza/${id}`)
